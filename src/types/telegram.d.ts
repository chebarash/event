...
declare namespace TelegramWebApps {
  ...
  interface CloudStorage {
    ...
    setItem(
      ...
      callback?:
        | ((error: Error) => void)
        | ((error: null, valueStored: boolean) => void)
    ): CloudStorage;
    /**
    ...
    removeItem(
      ...
      callback?:
        | ((error: Error) => void)
        | ((error: null, valueRemove: boolean) => void)
    ): CloudStorage;
    /**
  ...
  type SafeAreaChangedEventHandler = (this: {
    safeAreInset: SafeAreaInset;
  }) => void;
  ...
  type ClipboardTextReceivedEventHandler = (params: {
    data: string | null;
  }) => void;
  type BiometricAuthRequestedEventHandler = (
    params:
      | { isAuthenticated: true; biometricToken: string }
      | { isAuthenticated: false }
  ) => void;
  type BiometricTokenUpdatedEventHandler = (params: {
    isUpdated: boolean;
  }) => void;
  type FullscreenChangedEventHandler = (this: {
  ...
  type AccelerometerFailedEventHandler = (params: {
    error: "UNSUPPORTED";
  }) => void;
  ...
  type DeviceOrientationFailedEventHandler = (params: {
    error: "UNSUPPORTED";
  }) => void;
  type GyroscopeChangedEventHandler = (this: {
    x: number;
    y: number;
    z: number;
  }) => void;
  type GyroscopeFailedEventHandler = (params: { error: "UNSUPPORTED" }) => void;
  type LocationRequestedEventHandler = (params: {
